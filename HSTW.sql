...
CREATE TABLE IF NOT EXISTS `hstw`.`buro_credito` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `folio_consulta` VARCHAR(45) NULL DEFAULT NULL,
  `nombre` VARCHAR(45) NULL DEFAULT NULL,
  `apellido_p` VARCHAR(45) NULL DEFAULT NULL,
  `apellido_m` VARCHAR(45) NULL DEFAULT NULL,
  `fecha_nacimiento` DATE NULL DEFAULT NULL,
  `rfc` VARCHAR(45) NULL DEFAULT NULL,
  `id_direcciones` INT(11) NULL DEFAULT NULL,
  `adeudo` INT(11) NULL DEFAULT NULL,
  `id_instutuion` INT(11) NULL DEFAULT NULL,
  `estado` VARCHAR(45) NULL DEFAULT NULL,
  `comportamiento` VARCHAR(45) NULL DEFAULT NULL,
  `curp` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `hstw`.`fechas_de_pago` (
  ...
  `fechas` DATE NULL DEFAULT NULL,
  `monto` INT(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  INDEX `f_s_sa_idx` (`id_credito` ASC),
  CONSTRAINT `f_s_sa`
